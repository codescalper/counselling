...
export default function Pricing() {
  return (
    ...
    <section className="min-h-screen w-full py-12 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-sky-950 dark:to-blue-950 flex items-center justify-center">
